...
user_settings = {
    user_spells = {
        Healing = T{"Cura II","Cura III","Curaga","Curaga II","Curaga III","Curaga IV","Curaga V","Cure","Cure II","Cure III","Cure IV","Cure V","Cure VI","Esuna","Reraise","Reraise II","Reraise III"},
        Geomancy = T{"Indi-Refresh","Indi-Poison","Indi-Precision","Indi-Voidance"},
        Enhancing = T{"Baraera","Baraero","Barblizzara","Barblizzard","Barfira","Barfire","Barstone","Barstonra","Barthunder","Barthundra","Barwater","Barwatera"},
        Ninjutsu = T{},
        Singing = T{},
        Blue = T{},
        Summoning = T{"Carbuncle","Cait Sith","Diabolos","Fenrir","Garuda","Ifrit","Leviathan","Ramuh","Shiva","Titan","Air Spirit","Dark Spirit","Earth Spirit","Fire Spirit","Ice Spirit","Light Spirit","Thunder Spirit","Water Spirit"}},
